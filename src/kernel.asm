...
versionText:    db 0xA, 0xD, '  ', \
                0xA, 0xD, '  Microbit [Version 0.1.0-rc1]', 0xA, 0xD, 0
welcomeText:    db '  Kernel Booted, Welcome To Microbit OS!', 0xA, 0xD, \
                '  ', 0xA, 0xD, 0xA, 0xD, 0
menuText:       db '  F) File & Program Browser / Loader', 0xA, 0xD, \
                '  N) End Program', 0xA, 0xD, '  R) Reboot', 0xA, 0xD, 0xA, 0xD, '  > ', 0
...
fileTableHeading: db 0xA, 0xD, '  File/Program         Sector', 0xA, 0xD, 0xA, 0xD, '  ', 0
commandString:  db '', 0

;; Sector Padding Magic
times 512-($-$$) db 0       ; Pad File With 0s Until 512th Byte
